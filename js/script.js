...
let conteinerPesquisa = document.querySelector('.pesquisar');
...
let conteinerProducao = document.querySelector('.producao');
...
pesquisa.addEventListener('click', function(){
    conteinerPesquisa.style.display = 'flex';
    ...
    conteinerProducao.style.display = 'none';
});
geral.addEventListener('click', function(){
    conteinerGeral.style.display = 'flex';
    conteinerPesquisa.style.display = 'none';
    conteiner.style.display = 'none';
    conteiner1.style.display = 'none';
    conteiner2.style.display = 'none';
    conteiner3.style.display = 'none';
...
producao.addEventListener('click', function() {
    conteinerProducao.style.display = 'flex';
    conteinerSeries.style.display = 'none';
    conteinerGeral.style.display = 'none';
    conteinerPesquisa.style.display = 'none';
    conteiner.style.display = 'none';
